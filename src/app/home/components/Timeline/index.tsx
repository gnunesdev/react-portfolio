    ...
    <section className="bg-indigo-950">
      <div className="m-auto max-w-screen-2xl p-20">
        ...
        <div className="mt-8 flex flex-wrap gap-8">
          <div className="flex h-fit w-72 flex-col rounded-2xl bg-indigo-900">
          ...
          <div className="flex h-fit w-72 flex-col rounded-2xl bg-indigo-900">
            ...
            <div className="p-4">
              <p>
                Atuei como líder de squad e desenvolvedor frontend, responsável
                por coordenar e entregar sites de e-commerce. Principais
                clientes: Yamaha, Boticário, Armázem Paraíba.
              </p>
          ...
          <div className="flex h-fit w-72 flex-col rounded-2xl bg-indigo-900">
            ...
            <div className="p-4">
              <p>
                ...
                delivery Pedefácil, responsável por criar novas funcionalidades,
                testes, e acompanhar erros e métricas em produção.
              </p>
              <p className="mt-4">Tecnologias:</p>
          ...
          <div className="flex h-fit w-72 flex-col rounded-2xl bg-indigo-900">
            ...
            <div className="p-4">
              <p>
                Atuo em um time de tecnologia, mantendo uma plataforma utilizada
                por operadores e internos com arquitetura de micro frontend,
                auxiliando na integração de novos times e definindo a
                arquitetura.
              </p>
              <span className="mt-4">Tecnologias:</span>
              <ul className="mt-2 flex flex-wrap gap-2">
